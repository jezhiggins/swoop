...
class Saucer(
    ...
    private val firedStep = if (!wave.players.allDead()) Random.nextDouble(0.4 - (0.07 * aggressiveness), 0.4) else 1000.0
    ...
    private fun fireIfReady(distance: Float) {
        ...
        val direction = position.angleTo(wave.players.randomChoice().position)
